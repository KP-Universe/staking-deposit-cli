...
# 수정 시작 지점
# KPUniverse setting
KPUniverseSetting = BaseChainSetting(
    NETWORK_NAME=KPUNIVERSE, GENESIS_FORK_VERSION=bytes.fromhex('20000089'),
